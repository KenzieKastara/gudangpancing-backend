...
import { Admin, CarouselItem, InstagramPost, SiteSetting } from './src/models/index.js';
...
async function seed() {
  try {
    ...
    await SiteSetting.deleteMany({}); // Clear existing
    ...
    // 3. Create carousel items
    console.log('\nCreating carousel items...');
    await CarouselItem.deleteMany({}); // Clear existing
    ...
    await InstagramPost.insertMany(igPosts);
